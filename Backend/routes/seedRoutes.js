  ...
  const [services, maintenancePlans, libraryArticles, cms] = await Promise.all([
    Service.create([
      ...
      },
      {
        ...
        description: "Customized soil nutrition plans and organic bio-nutrients to restore vitality, enhance growth, and ensure the long-term health of your plants.",
        features: ["Organic Soil & Bio-Nutrients", "Micro-Element Drenching", "Seasonal Feeding Schedule"],
    ...
    MaintenancePlan.create([
      {
        name: "Partial",
        slug: "partial",
        description: "We monitor and guide you with customized care instructions. You perform basic care and share plant updates regularly for monitoring.",
        features: [
          "Plant health observation",
          "Customized maintenance checklist",
          "Watering guidance",
          "Fertilizer recommendations",
          "Basic plant care instructions",
          "Seasonal care guidance",
          "Issue monitoring via photos",
          "Online support",
          "Wellness tracking"
        ],
        priceNote: "Charges vary based on number of plants, condition, space, and monitoring frequency.",
        sortOrder: 1,
      },
      {
        name: "Fully Customized",
        slug: "fully-customized",
        description: "Our team takes complete responsibility for plant wellness — scheduled visits, treatment, repotting, everything.",
        features: [
          "Complete plant health monitoring",
          "Scheduled watering services",
          "Fertilizing & nutrient care",
          "Pruning & trimming",
        ...
        priceNote: "Charges depend on plant count, space size, plant type and frequency.",
        sortOrder: 2,
      },
    ]),
