...
const allowedOrigins = (process.env.CLIENT_ORIGIN || "http://localhost:5173,https://plantation-yogini.netlify.app,https://plantations.onrender.com,https://yoginiplanters.com")
  .replace(/['"]/g, "")
  .split(",")
